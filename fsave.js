...
_("demo").innerHTML = '<p style="color:red">Selesai, Scroll perlahan ke bagian paling bawah artikel dan klik tombol &quot;Gotolink Now&quot; warna hijau dibawah ya</p>';
_("bawahnih").innerHTML = '<p><a href="'+mytext+'" rel="nofollow noopener" target="_blank" class="btnBlock btnBlocks">Go To Link Now</a></p>';
}
